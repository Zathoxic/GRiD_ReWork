...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 03 mrt 2016 om 13:46
...
(4, 'test1', 'tuahsdifoghjkhjgfdsas'),
(5, 'test2', 'qwerfghjiuytrsea'),
(6, 'asdsd', 'asad'),
(7, 'sadasdasd', 'asdsada'),
(8, 'asdasdsad', 'asdsad'),
(9, 'sadad', 'asdadad'),
(10, 'asifdghkd', 'sadsadd');
...
INSERT INTO `projects` (`id`, `title`, `content`, `enabled`) VALUES
(1, 'test project 1', '<p>ioygkl;saddsadsadsab&nbsp;<span style="text-decoration: line-through;">sadasdadasd</span></p>', 1),
(2, 'test project 2', '<h1>hoi</h1>\n<p>dit is een test project.....</p>\n<ul>\n<li>1</li>\n<li>2</li>\n<li>3</li>\n<li>4</li>\n<li>5</li>\n<li>6</li>\n<li>7</li>\n<li>8</li>\n<li>9</li>\n</ul>', 1),
(3, 'test project 3', '<p>owredpsf</p>', 1),
(4, 'test project 4', '<p>sajkfgakjshsajfhjkasf</p>', 1),
(5, 'Financieel Consultant die wij via Arlande willen inzetten.', '<p>lol</p>', 1),
(6, ' Financieel Consultant die wij via Arlande willen inzetten.', '', 1);
...
('root', '[{"db":"grid_imo","table":"projects"},{"db":"grid_imo","table":"news"}]');
...
('root', '2016-02-18 10:53:03', '{"lang":"nl","collation_connection":"utf8mb4_unicode_ci"}');
